    ...
    contactForm.addEventListener('input', function(e) {
      if (e.target.matches('input, textarea, select')) {
        if (e.target.classList.contains('error')) {
          ...
          if (value && (e.target.type !== 'email' || isValidEmail(value))) {
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "[User's Name] uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var response = await fetch(apiBase + '/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '7cd7206e-b836-4861-884c-24205573a2ec',
                    name: data.name || '',
                    email: data.email || '',
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7cd7206e-b836-4861-884c-24205573a2ec';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7cd7206e-b836-4861-884c-24205573a2ec';
